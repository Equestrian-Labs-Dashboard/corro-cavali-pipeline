...
def build_smartrr_product_volume_rows(now_str, brand_name, active_states, period_defs):
    ...
    For every selected period/product row:
      ...
      - active_subscribers_current = ACTIVE line-items for that product created from the beginning
        through the selected period end date.
      - paused_subscribers_current = PAUSED line-items for that product created from the beginning
        through the selected period end date.
